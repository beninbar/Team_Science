---
title: "Generate Keywords Database"
author: "Anthony A"
date: "10/22/2022"
...
if (writeReports) {
  write.csv(aggregates, here::here("data/outputs/aggregateLinkedinPhrases.csv"), row.names = FALSE)
  write.csv(singularAggregates, here::here("data/outputs/aggregateLinkedinKeywords.csv"), row.names = FALSE)
}
